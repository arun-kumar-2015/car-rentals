              ...
              <div className="bg-primary/5 p-6 rounded-2xl border border-primary/20 flex justify-between items-center shadow-inner">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="bg-background/50 border-primary/20 text-primary uppercase font-black text-[9px] px-2">
                      {formData.rentalType}
                    </Badge>
                    <Badge variant="secondary" className="bg-primary text-black font-black text-[9px] px-2">
